...
public class Vec3d
{
  ...
  {
    return new Vec3d( this.yCoord * vec.zCoord - this.zCoord * vec.yCoord, this.zCoord * vec.xCoord - this.xCoord * vec.zCoord,
   ...
   */
  public static Vec3d fromPitchYawVector( Vec2f pitchYaw )
  {
    return fromPitchYaw( pitchYaw.x, pitchYaw.y );
  }
